...
# Título do Login
tk.Label(root_login, text="AB9 CRM", font=("Arial", 22, "bold"), fg="#FFD700", bg="#0F1620").pack(pady=30)
...
#Regras de Login
usuarios_validos = ["CEO_Maik", "Vendedor_Gomes", "Suporte_Pedro", "A"] #Usuarios permitidos
senha_correta = "AB"
tentativas = 0
max_tentativas = 3
...
def criar_janela_Taurion(usuario):
    ...
    Taurion = tk.Tk()
    Taurion.title(f"AB9 CRM - Taurion - {usuario}")
    ...
    tk.Label(header, text="AB9 CRM - TAURION", 
    ...
    # ==================== TAURION - ABA PRINCIPAL ====================
    aba_taurion = ttk.Frame(abas)
    abas.add(aba_taurion, text="            TAURION         ")

    tk.Label(aba_taurion, text="TAURION - Dashboard Principal", 
    ...
    # ==================== GEMINI - Potenciais Clientes ====================
    aba_gemini = ttk.Frame(abas)
    abas.add(aba_gemini, text="         GEMINI          ")

    tk.Label(aba_gemini, text="GEMINI - Potenciais Clientes e Leads", 
             font=("Arial", 18, "bold")).pack(pady=30)
    ...
    btn_carregar = ttk.Button(aba_pegasus, text="📂 Carregar Logística (logistica.txt)", 
